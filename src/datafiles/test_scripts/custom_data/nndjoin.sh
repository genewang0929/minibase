...
echo '--------------------------------'
echo "Creating database mydb, table1, table2"
java batchcreate ./datafiles/phase3/custom_data/create_for_delete_1.txt table1
java batchcreate ./datafiles/phase3/custom_data/insert_table2_for_djquery.txt table2
...
echo '--------------------------------'
echo "Performing NN DJoin Query"
java query2 table1 table2 ./datafiles/phase3/djquery_nn.txt 1000